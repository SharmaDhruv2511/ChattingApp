            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                     ...
                     children: [
                       ...
                       Positioned(
                         ...
                         child: MaterialButton(
                           ...
                           child: Icon(Icons.edit, color: Colors.green,), color: Colors.white,),
                       )
                  ...
                  Text(widget.user.email, style: TextStyle(color: Colors.black54, fontSize: 16, fontWeight: FontWeight.bold),),
                  ...
                  ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.green,shape: StadiumBorder(), minimumSize: Size(mq.width* .4, mq.height * .05)),
                    onPressed: (){
